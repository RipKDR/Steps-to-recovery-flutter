...
void drawRecoveryStairs(
  ...
  // Colors
  final amberPrimary = img.ColorRgb8(245, 158, 11); // #F59E0B
  final amberLight = img.ColorRgb8(251, 191, 36); // #FBBF24
  final amberDimmed = img.ColorRgba8(245, 158, 11, 230); // 90% opacity
...
void drawRoundedRect(
  ...
  img.fillRect(image, x1: left, y1: top, x2: right, y2: bottom, color: color);
