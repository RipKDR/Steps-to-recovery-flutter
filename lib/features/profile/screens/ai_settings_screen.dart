          ...
          body: ListView(
            ...
            children: [
              ...
              SwitchListTile(
                ...
                onChanged: (value) => AppStateService.instance.setAiProxyEnabled(value),
              ),
              const SizedBox(height: AppSpacing.md),
              const ListTile(
                contentPadding: EdgeInsets.zero,
                leading: Icon(Icons.shield_outlined, color: AppColors.primaryAmber),
                title: Text('Crisis-aware fallback'),
                subtitle: Text('Immediate support actions stay local and available offline'),
              ),
              ...
              const ListTile(
                contentPadding: EdgeInsets.zero,
                leading: Icon(Icons.cloud_outlined, color: AppColors.primaryAmber),
                title: Text('Cloud proxy'),
                subtitle: Text('This setting is persisted for future backend wiring'),
              ),
            ],
          ),
        );
