    ...
    return ListView(
      ...
      children: [
        ...
        InkWell(
          ...
          onTap: () => context.go(
            (!d.morningDone || !d.eveningDone) ? '/checkin' : '/journal',
          ),
          child: Ink(
            decoration: BoxDecoration(
          ...
          Column(
            children: [
              FilledButton(
                ...
                child: Text(
                  d.morningDone ? '✓ Morning done' : 'Mark morning done',
                ),
              ),
              ...
              FilledButton(
                ...
                child: Text(
                  d.eveningDone ? '✓ Evening done' : 'Mark evening done',
                ),
              ),
              const SizedBox(height: 10),
              FilledButton(
        ...
        panel(
          Column(
            ...
            children: [
              ...
              Text(
                'Completed rituals today: $completed/2',
                style: const TextStyle(fontSize: 18),
              ),
            ],
          ),
